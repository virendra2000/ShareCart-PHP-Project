...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="manageads.php" class="active"><i class='bx bx-images icon' ></i>Manage My Ads</a></li>
	...
	<section id="content">
		...
		<main>
			...
			?>
			<div class="crud-oper">
					<form method="POST" action="updateadsconfig.php" enctype="multipart/form-data">
						<label>Campaign Name</label>&nbsp
						<input type="text" placeholder="Enter Campaign Name"  name="cname" class="textedit" value="<?php echo $fetching['campaignname'] ?>"><br><br>
						<label>Campaign Description</label>&nbsp
						<input type="text" placeholder="Enter Campaign Description"  name="cbtndesc" class="textedit" value="<?php echo $fetching['campaigndesc'] ?>"><br><br>
						<label>Campaign Button Name</label>&nbsp
						<input type="text" placeholder="Enter Campaign Button Name"  name="btnname" class="textedit" value="<?php echo $fetching['campaignbtnname'] ?>"><br><br>
						<label>Campaign Link</label>&nbsp
						<input type="text" placeholder="Enter Campaign Link"  name="btnlink" class="textedit" value="<?php echo $fetching['campaignbtnlink'] ?>"><br><br>
						...
						<br><br>
						<p style="color: red;font-weight:bold">Note :) Upload new image or upload image when updating ad</p><br>
