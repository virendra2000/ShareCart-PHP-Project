...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="#" class="active"><i class='bx bx-plus icon'></i>Watchlist</a></li>
	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				<li><a href="#">Home</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Watchlist</a></li>
			</ul>
			...
			<div class="crud-oper">
					<?php
						if ($_SERVER["REQUEST_METHOD"] == "POST") {
							...
							$results = mysqli_query($con, "SELECT * FROM watchlist WHERE username='".$fetch_info['name']."' AND stocksymbol LIKE '%$searchinp%'");
						}
						else {
							$results = mysqli_query($con, "SELECT * FROM watchlist WHERE username='".$fetch_info['name']."'");
						}	
					?>
					...
					<?php while ($row = mysqli_fetch_array($results)) { ?>
						<a href="trade.php?addid=<?php echo $row['id']; ?>">
							<div class="card">
								<div class="head">
									<div>
										<h1 style="color:black;font-size: 24px"><?php echo $row['stocksymbol']; ?></h1><br>
