        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="adminlogin.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="adlogin" value="Login">
                    </div>
                    <div class="link login-link text-center">Not yet a member? <a href="adminregister.php">Signup now</a></div>
                </form>
            </div>
        </div>
    </div>
