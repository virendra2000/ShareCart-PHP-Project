...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="insertstockdetail.php" class="active"><i class='bx bx-import icon' ></i> Import Stock Detail</a></li>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h5><a href="">Home</a> | Insert Stock Detail</h5><br>
			<div class="main-body">
			<div class="row">
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body">
							<form action="stocklistimport.php" method="post" name="upload_excel" name="upload_excel" enctype="multipart/form-data">
							<div class="row mb-3">
								<div class="col-sm-3">
