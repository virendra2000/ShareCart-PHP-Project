	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				<li><a href="#">Home</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Manage Ads</a></li>
			</ul>
			<br><br>
				<div class="crud-oper">
					...
					<?php
						if ($_SERVER["REQUEST_METHOD"] == "POST") {
							...
							$results = mysqli_query($con, "SELECT * FROM ads WHERE campaignname LIKE '%$searchinp%'");
						}
						else {
							$results = mysqli_query($con, "SELECT * FROM ads");
						}	
					?>
					<table class="record">
						<thead>
						...
						<tr>
							...
							<td><?php echo $row['campaignbtnlink']; ?></td>
							<td><a href="updateads.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Edit</a></td>
							<td><a href="deleteadconfig.php?deleteadid=<?php echo $row['id']; ?>" class="del_btn">Delete</a></td>
						</tr>
						<?php } ?>
					</table>
				</div>
